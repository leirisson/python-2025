"""
jurimetria/coleta/coletar_datajud.py
--------------------------------------
...
TRIBUNAIS_ESTADUAIS = {
    "tjsp": ("TJSP", "SP"),   "tjrj": ("TJRJ", "RJ"),   "tjmg": ("TJMG", "MG"),
    "tjrs": ("TJRS", "RS"),   "tjpr": ("TJPR", "PR"),   "tjsc": ("TJSC", "SC"),
    "tjba": ("TJBA", "BA"),   "tjpe": ("TJPE", "PE"),   "tjce": ("TJCE", "CE"),
    "tjgo": ("TJGO", "GO"),   "tjpa": ("TJPA", "PA"),   "tjma": ("TJMA", "MA"),
    "tjms": ("TJMS", "MS"),   "tjmt": ("TJMT", "MT"),   "tjrn": ("TJRN", "RN"),
    "tjal": ("TJAL", "AL"),   "tjpi": ("TJPI", "PI"),   "tjse": ("TJSE", "SE"),
    "tjro": ("TJRO", "RO"),   "tjam": ("TJAM", "AM"),   "tjto": ("TJTO", "TO"),
    "tjap": ("TJAP", "AP"),   "tjac": ("TJAC", "AC"),   "tjrr": ("TJRR", "RR"),
    "tjpb": ("TJPB", "PB"),   "tjes": ("TJES", "ES"),   "tjdft": ("TJDFT", "DF"),
}

TRIBUNAIS_TRABALHO = {
    "trt1":  ("TRT-1",  "RJ"),     "trt2":  ("TRT-2",  "SP"),
    "trt3":  ("TRT-3",  "MG"),     "trt4":  ("TRT-4",  "RS"),
    "trt5":  ("TRT-5",  "BA"),     "trt6":  ("TRT-6",  "PE"),
    "trt7":  ("TRT-7",  "CE"),     "trt8":  ("TRT-8",  "PA/AP"),
    "trt9":  ("TRT-9",  "PR"),     "trt10": ("TRT-10", "DF/TO"),
    "trt11": ("TRT-11", "AM/RR"),  "trt12": ("TRT-12", "SC"),
    "trt13": ("TRT-13", "PB"),     "trt14": ("TRT-14", "RO/AC"),
    "trt15": ("TRT-15", "SP-int"), "trt16": ("TRT-16", "MA"),
    "trt17": ("TRT-17", "ES"),     "trt18": ("TRT-18", "GO"),
    "trt19": ("TRT-19", "AL"),     "trt20": ("TRT-20", "SE"),
    "trt21": ("TRT-21", "RN"),     "trt22": ("TRT-22", "PI"),
    "trt23": ("TRT-23", "MT"),     "trt24": ("TRT-24", "MS"),
}
...
def processar_hit(hit: dict, segmento: str) -> dict | None:
    src  = hit.get("_source", {})
